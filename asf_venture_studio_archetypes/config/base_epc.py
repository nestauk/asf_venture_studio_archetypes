...
# List without efficiency scores and coefficient


EPC_FEAT_NUM_KMEANS_NOSCORES = [
    # "CO2_EMISSIONS_CURRENT",
    # "CO2_EMISS_CURR_PER_FLOOR_AREA",
    # "CURRENT_ENERGY_EFFICIENCY",
    # "ENERGY_CONSUMPTION_CURRENT",
...
EPC_FEAT_ALL_KPROTO = EPC_FEAT_CAT_KPROTO + EPC_FEAT_NUM_KPROTO
